...
describe('MarketingLanding', () => {
  const landingPayload = {
    ...
    featuredQuestions: [
      ...
      { id: 'java-q', library: 'java-foundations', title: 'Q19：HashMap 的 put 和 get 流程是什么？', readMinutes: 2, sectionTitle: '集合框架' },
      { id: 'ai-q', library: 'java-ai-applications', title: 'Q17：什么是 RAG？完整流程有哪些？', readMinutes: 2, sectionTitle: 'RAG 与 Agent 工作流' },
    ],
    tracks: [
