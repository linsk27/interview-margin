...
当前包含 10 个题库、568 道题：原有简历题 81 道、JavaScript 100 道，Git、Vue、React、
前端工程、后端、数据库缓存和网络部署共 320 道工程题，以及 67 道 360 AI 应用前端一面
专项题。
...
当前内容基线为 10 个题库、568 题和 568 个唯一 ID；487 道结构化富题解均经过正文、
段落标记和来源门禁，19 道核心题含站内 SVG 图解；34 个测试文件、168 项测试与生产构建
全部通过。
...
生成器会校验题号、标题、正文结构和来源，保持 568 个当前公开题目 ID 不变；已经发布后退休的
